...
public class SunHalo {
    ...
    public static final int MULT_FOR_GETTING_TOP_LEFT_CORNER = 2;
    ...
    public static GameObject create(GameObject sun){
        ...
        Vector2 topLeftCorner = new Vector2(sun.getCenter()).subtract(sunSize.mult(MULT_FOR_GETTING_TOP_LEFT_CORNER));
